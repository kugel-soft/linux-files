...
dirC=/home/ricardo/.wine/drive_c
dirCase=ec@se++
...
if [ ! -d $dirC/$dirCase/estavel ]
then
    mkdir $dirC/$dirCase/estavel
fi

if [ ! -d $dirC/$dirCase/estavel/ireport ]
then
    mkdir $dirC/$dirCase/estavel/ireport
fi

if [ ! -d $dirC/$dirCase/estavel/ireportAtual ]
then
    mkdir $dirC/$dirCase/estavel/ireportAtual
fi

if [ ! -d $dirC/$dirCase/estavel/jdk ]
then
    mkdir $dirC/$dirCase/estavel/jdk
fi

if [ ! -d $dirC/$dirCase/telajava ]
then
    mkdir $dirC/$dirCase/telajava
fi

if [ ! -d $dirC/$dirCase/lib ]
then
    mkdir $dirC/$dirCase/lib
fi

if [ ! -d $dirC/$dirCase/KIns ]
then
    mkdir $dirC/$dirCase/KIns
fi

if [ ! -d $dirC/$dirCase/estavel/imagens ]
then
    mkdir $dirC/$dirCase/estavel/imagens
fi

if [ ! -d $dirC/$dirCase/out ]
then
    mkdir $dirC/$dirCase/out
fi

echo "Atualizando ECASE..."
...
cd $dirC
cd $dirCase/estavel
wine ClienteCase.exe 192.168.4.5 &> /dev/null &
